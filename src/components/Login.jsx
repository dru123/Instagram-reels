...
//             //   setEmail("");
//             //   setPassword("");
// //agr hum setemaila nd password line 19 0r 20 yh likhte toh memeory leak k error ata h kuki humne phle rout pr push kr diya or bd mm state chnage kr rhe jis wjh s error ata leak k 
//     }
//    return(
//        <div>
...
//           </div>
//           <button  type="submit" onClick={handleSubmit }disabled={loader}>Submit</button>
//       </form>
//       </div>
//    )
// }
...
//             <button type="submit" disbaled={loader} onClick={handleLogin}>Login</button>
//             </form>
//         </div>
//     )
// }
...
import { CarouselProvider, Slider, Slide, ButtonBack, ButtonNext,Image
        ...
        <div className={classes.centerDivs}>
            ...
            <Grid container   className={classes.alignCenter} spacing={2}>
                <Grid item sm={4}>
                    ...
                    <div className='imgcar' style={{ backgroundImage: `url(` + Insta + `)`, backgroundSize: 'cover' ,marginTop:"-5rem",marginLeft:"-5rem"}}>
        <div className='caro'>
          <CarouselProvider
            visibleSlides={1}
            totalSlides={5}
           ...
           <Grid item sm={5}>
               <Card variant="outlined">
                ...
                <CardContent className={classes.centreElemets}>
                    <TextField  value={email} id="outlined-basic" label="email" variant="outlined" size="small" display="block"
                   className={classes.mb}  
                   onChange={(e) =>{setEmail(e.target.value)}}/>
                   <TextField  value={password}  type="password" label="password" id="outlined-basic" variant="outlined" 
                   display="block"
                   size="small"
                   className={classes.mb}
               ...
               <CardActions>
                 <Button  variant="contained" className={classes.fullWidth} onClick={handleSubmit} disabled={loader} color="primary">Login</Button>
               </CardActions>

               </Card>
               <Card varaint="outlined">
                <Typography style={{textAlign:"center"}}>
                    Don't have an account?
                    <LinkButton content="Signup"
